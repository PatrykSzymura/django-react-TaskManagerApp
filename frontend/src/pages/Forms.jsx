...
async function fetchDataFromApis(project) {
    try {
      const prioritiesResponse = await fetch("api/get/priorities");///api/v1/overall/get_priorities
  ...
  const Add_Project_Form = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        setLoading(true);
        const res = await fetch("api/projects/create", { ///api/v1/projects/add_project
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
export const Add_Task_Form = ({ projectId }) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        setLoading(true);
        const res = await fetch(`/api/get/task/${projectId}`, {///api/v1/task/
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
export const DesChangeForm = ({ forWhat, elementId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (forWhat === "project") {
      await fetch(`/api/get/projects/${elementId}`, {//api/v1/projects
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      await fetch(`/api/get/projects/${elementId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handlePersonSubmit = async (e) => {
    ...
    await fetch(`/api/update/task/${elementId}`, {///api/v1/task/executor/
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const handleTeamSubmit = async (e) => {
    ...
    await fetch(`/api/create/project/${elementId}`, {//api/v1/projects/get_project/
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
